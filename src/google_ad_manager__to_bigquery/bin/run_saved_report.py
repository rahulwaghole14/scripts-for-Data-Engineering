...
def preprocess_data(dataframe):
    ...
    logging.info("Data types in the DataFrame after preprocessing:")
    for col in dataframe.columns:
        logging.info(f"Column: {col}, Type: {dataframe[col].dtype}")
...
def run_report_validated(
    ...
    if "results" in response and len(response["results"]):
        ...
        if saved_query["isCompatibleWithApiVersion"]:
            ...
            logging.info("Validating the data against the pydantic model...")
