...
headers = {'Authorization':'Token 20039f24-0dd8-4df8-8b02-92b1ef601b71'}  # Replace with your actual token
    ...
    while flag:
        try:
            ...
            if res.status_code != 200:
                logging.error(f'Failed to fetch data for {resource} on page {page_number}: {res.status_code}')
                break
...
if __name__ == "__main__":
    resources = ['subscriptions', 'transactions', 'users']  # Replace with actual resource names
