"""
this script is to read data from s3 bucket
and load it into sql server 2017
"""
# pylint: disable=all
...
file_name = os.getenv("file_name_generic")
...
# INFO:root:Index(['Email', 'Label (Subscriptions/Service)',
#        'Internal name (Subscriptions/Service)'],
#       dtype='object')
old_columns = [
    "Email",
    "Label (Subscriptions/Service)",
    "Internal name (Subscriptions/Service)",
]

# # # New column names
new_columns = ["email", "label", "internal_name"]
