...
try:
    ...
    # dbt_command = ["dbt", "build", "--select", "+tag:presspatron_api"] # build introduce run test before materialise downstream models
    dbt_command = [
        "dbt",
        "run",
        "--models",
        "int_presspatron__bq_to_braze_user_profile",
